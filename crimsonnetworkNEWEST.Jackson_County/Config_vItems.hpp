...
class VirtualShops {
    ...
    class market {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw", "zipties", "blindfold" };
    };
    ...
    class rebel {
        ...
        license = "rebel";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge", "zipties", "blindfold", "hackingtool", "speedbomb" };
    };
    ...
    class cop {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "donuts", "coffee", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "toolkit", "fuelFull", "defusekit", "defibrillator", "keycard" };
    };
};
...
class VirtualItems {
	...
	class hackingtool {
        variable = "hackingtool";
        displayName = "STR_Item_htool";
        weight = 15;
        buyPrice = 60000;
        sellPrice = 10000;
        illegal = true;
        edible = -1;
        icon = "icons\ico_hackingtool.paa";
    };
