...
if (_copamount < 0) exitwith {["You cannot do this without a minimum of 7 police on duty.",30,"red"] call A3L_Fnc_Msg; [true, "blastingcharge", 1] call life_fnc_handleInv;};
...
prisondoor2 animate ['maindoor1', 1]; 
